...
<body onload="Carga()">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item mx-2 dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <li><a id="Matrimoniales" class="dropdown-item letra-grande" href="habitaciones.html" onclick="Load(this.id)">Matrimoniales</a></li>
                  <li><a id="Dobles" class="dropdown-item letra-grande" href="habitaciones.html" onclick="Load(this.id)">Dobles</a></li>
                  <li><a id="Triples" class="dropdown-item letra-grande" href="habitaciones.html" onclick="Load(this.id)">Triples</a></li>
                  <li><a id="Queen" class="dropdown-item letra-grande" href="habitaciones.html" onclick="Load(this.id)">Queen</a></li>     
                </ul>
              </li>
              <li class="nav-item mx-2">
  ...
  <div id="primer-fade" class="primer-fade">
          ...
          <div class="row justify-content-center align-items-center">
            <div class="col-md-7">
              ...
              <div class="container-fluid d-flex justify-content-center">
                <a class="btn btn-amarillo pb-2 pt-2 px-4 mb-4" href="encuentranos.html" style="font-weight: 500;">Leer más</a>
              </div>
            </div>
      ...
      <!-- Tarjeta de Servicio -->
      <div class="container-fluid pb-3 fade-in">
        ...
        <ul class="d-flex flex-wrap my-0 mx-auto col-xsm-12 col-sm-10 col-md-10 col-lg-6" style="padding-right: 2rem; padding-left: 2rem;">
          ...
          <li class="p-4 card justify-content-center align-items-center col-xsm-6 col-sm-6 col-md-3 col-lg-3 item-serv" data-testid="grid-item-4" aria-label="Free parking">
            ...
            <p data-testid="grid-item-label-4" class="p-1" style="color: gray; font-size:0.8em; text-align: center;"><b>Servicio de desayuno</b></p>
          </li>
      ...
      <div class="container-fluid texture pb-3">
        ...
        <div class="container-fluid" style="width: 100%;">
          <div class="d-flex flex-wrap my-0 mx-auto col-xsm-12 col-sm-12 col-md-12 col-lg-10" style="padding-right: 2rem; padding-left: 2rem;">
            <a class="col-xsm-12 col-sm-6 col-md-6 col-lg-3 slide-in from-down" id="Dobles" href="habitaciones.html" onclick="Load(this.id)">
              <div class="card text-white card-room">
                ...
                <div class="card-img-overlay">
                  <h5 class="room-bg"></h5>
                  <div class="room-title">DOBLES</div>
                </div>
              </div>
            </a>
            <a class="col-xsm-12 col-sm-6 col-md-6 col-lg-3 slide-in from-down" id="Triples" href="habitaciones.html" onclick="Load(this.id)">
              <div class="card text-white card-room">
                ...
                <div class="card-img-overlay">
                  <h5 class="room-bg"></h5>
                  <div class="room-title">TRIPLES</div>
                </div>
              </div>
            </a>
            <a class="col-xsm-12 col-sm-6 col-md-6 col-lg-3 slide-in from-down" id="Matrimoniales" href="habitaciones.html" onclick="Load(this.id)">
              <div class="card text-white card-room">
            ...
            <a class="col-xsm-12 col-sm-6 col-md-6 col-lg-3 slide-in from-down" id="Queen" href="habitaciones.html" onclick="Load(this.id)">
              <div class="card text-white card-room">
                ...
                <div class="card-img-overlay">
                  <h5 class="room-bg"></h5>
                  <div class="room-title">QUEEN</div>
                </div>
              </div>
            </a>
          </div>
      ...
      <!-- Lugares Turísticos -->
      <div class="container-fluid pb-3 carousel col-md-12 col-lg-12 col-xl-9 d-block fade-in">
        ...
        <div class="d-block mb-4 mt-4">
          <ul class="d-flex flex-wrap lista_tours p-3" style="list-style: none;">
            <li class="punto d-flex flex-wrap justify-content-center position-relative col-md-3 col-lg-3">
            ...
            <li class="d-flex flex-wrap justify-content-center position-relative col-md-3 col-lg-3">
              <a class="link_tours" id="parquemates_link" href="javascript:void(0);" onclick="LinkTours(this.id);">Parque de los Mates Burilados</a>
            </li>
          </ul>
        </div>
        <div class="container-fluid d-block carousel col-md-11 col-lg-10 slide-in from-down">
          <div class="container-fluid p-0 offset-4 col-md-8 col-lg-8 img_tours">
            <div class="carousel-inner p-0 d-block card shadow">
              ...
              <img id="parquemates_img" class="img_tours img-fluid d-none" src="img/parque_mates.jpg" alt="hall.jpg" style="height: 32em; width: 100%;">
            </div>
          </div>  
          <div class="col-md-6 col-lg-5 text_tours" style="clear: none;">
            <div class="p-4 texto_card" style="background-color: #f4f4f4;">
              ...
              <div id="parqueidentidad_texto" class="mt-3 d-block" style="text-align: justify;">
                Ubicado a solo 5 minutos en auto o a pie desde el hotel. Este parque es reconocido por albergar canales, estatuas y portales que referencian a la cultura de toda de la región Junín. En las esculturas se pueden destacar diversos personajes célebres de la cultura wanka, como el "Picaflor de los Andes". Su diseño general está muy influenciado por el Parque Güell de Barcelona, España.
                <div>
                  <a class="btn btn-amarillo mt-4 pb-2 pt-2" href="https://goo.gl/maps/ovrHSy5uKYfmCB937" target="_blank" style="font-weight: 500;">Más información</a>
                </div>
              </div>
              ...
              <div id="plazadearmas_texto" class="mt-3 d-none" style="text-align: justify;">
                Huancayo capital de Junín, la hermosa Ciudad Incontrastable, nos da la bienvenida con su gran plaza de armas, la Plaza Constitución. Ubicada a solo 10 minutos en auto desde el hotel, también se puede ir a pie desde la avenida principal en la cual nos ubicamos. En esta plaza se ubica la catedral de Huancayo y es el punto referencial para salidas turísticas, además de ser el principal centro comercial, religioso, cívico y político de la ciudad.
                <div>
                  <a class="btn btn-amarillo mt-4 pb-2 pt-2" href="https://goo.gl/maps/SoskCjZhaSVqKv7k8" target="_blank" style="font-weight: 500;">Más información</a>
                </div>
              </div>
              ...
              <div id="cerritodelalibertad_texto" class="mt-3 d-none" style="text-align: justify;">
                Es un cerro ubicado a 7 minutos en auto desde el hotel. Es un área urbana que posee diversas instalaciones de turismo y recreación, incluyendo una capilla donde se celebran matrimonios, una piscina pública, el único zoológico de la ciudad y un mirador natural con una imponente y hermosa vista de toda la ciudad de Huancayo. Se encuentra comunicado directamente con el centro de la ciudad por la "Av. Giráldez".
                <div>
                  <a class="btn btn-amarillo mt-4 pb-2 pt-2" href="https://goo.gl/maps/AEzQFbwcTnGFGDSf9" target="_blank" style="font-weight: 500;">Más información</a>
                </div>
              </div>
              <h2 id="parquemates_titulo" class="m-0 d-none" style="text-transform: uppercase; font-weight: 330; text-align: center;">Parque de los mates Burilados</h2>
              <div id="parquemates_texto" class="mt-3 d-none" style="text-align: justify;">
                Ubicado a solo 15 minutos en auto desde el hotel. Es un bello parque temático inspirado en la artesanía del poblado de Cochas, que son los mates burilados. Cuenta con diversas instalaciones de turismo y recreación, incluyendo restaurantes típicos dentro y fuera del recinto y un mirador urbano en frente del parque, de donde se puede observartodo el poblado de Cochas.
                <div>
                  <a class="btn btn-amarillo mt-4 pb-2 pt-2" href="https://goo.gl/maps/MFmRoL5Ax8JhFtRw7" target="_blank" style="font-weight: 500;">Más información</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="footer-top">
            ...
            <div class="container-fluid d-flex flex-wrap col-xsm-11 col-sm-11 col-md-10 col-lg-7 col-uxl-7">
              ...
              <div class="col-xsm-7 col-sm-7 col-md-7 col-lg-4 col-uxl-4 mb-md-0 p-3 pe-0 no-spaces footer-bottom-space">
                ...
                <form action="https://formsubmit.co/reservas@delvalle-hotel.com" method="POST" class="subscribe-form">
