...
<body class="">
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light" style="background-color: #f5f5f5 !important;">
        <div class="container-fluid" style="width: auto !important;">
          <a class="navbar-brand" href="#"><img class="image-fluid logo" src="img/LogoHotel_del_Valle.jpg" alt="LogoHotel_del_Valle.jpg"></a>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <li><a class="dropdown-item letra-grande" href="#">Ejecutivas</a></li>
                </ul>
              </li>
              <li class="nav-item">
      ...
      <div id="carruselprincipal" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active" style="height: 32em;display: flex;">
            <div class="parallax" style="background-image: url('img/cuarto1.jpg');"></div>
          </div>
          <div class="carousel-item" style="height: 32em;display: flex;">
            <div class="parallax" style="background-image: url('img/cuarto2.jpg');"></div>
          </div>
          <div class="carousel-item" style="height: 32em;display: flex;">
          ...
          <div class="row justify-content-center align-items-center">
            <div class="col-md-7">
              <p class="g-fs-14 g-fs-md-18" style="text-align: justify;">
                Hotel del Valle tiene una excelente ubicación cerca de la Universidad Continental y de las principales avenidas de Huancayo. Cuenta con una impresionante e imponente vista tanto diurna como nocturna, con un estilo moderno complementado con una decoración elegante y natural. Además de contar con una infraestructura y el personal adecuado para hacer que tu estadía sea cómoda y agradable.
                Este hotel brinda un espacio turístico y acogedor para quienes buscan una experiencia inolvidable con el compromiso de brindar una atención de primera, con pulcritud y siendo muy preocupados en los detalles.
              </p>
            </div>
      ...
      <div class="container-fluid pb-3">
        ...
        <hr class="mb-4" style="color: #000000; width: 12%; height: 0.2em; border-radius: 0.1em; margin: auto;">
        <ul class="d-flex flex-wrap my-0 mx-auto col-xsm-10 col-sm-10 col-md-10 col-lg-6" style="padding-right: 2rem; padding-left: 2rem;">
      ...
      <div class="parallax-container pb-3">
        <div class="parallax-container" style="position: absolute;">
          <div class="parallax-img"></div>
          <div class="parallax-overlay">
            <h3 class="display-6 text-center p-3" style="font-weight: 500;"><strong>Habitaciones y Suites</strong></h3>
            <hr class="mb-4" style="color: #000000; width: 12%; height: 0.2em; border-radius: 0.1em; margin: auto;">
            <p style="text-align: center;">LOREM IPSUM DOLORE</p>
            <br>
          </div>
        </div>
      </div>
